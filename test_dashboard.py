...
class TestApi(unittest.TestCase):
    ...
    def test_prediction_green(self, mock_gauge, mock_write, mock_markdown, mock_requests_get):
        ...
        mock_write.assert_any_call(f"<h1 style='color: red; font-size: 36px;'>CREDIT REFUSE</h1>",unsafe_allow_html=True)
    ...
    def test_prediction_red(self, mock_gauge, mock_write, mock_markdown, mock_requests_get):
        ...
        mock_write.assert_any_call(f"<h1 style='color: green; font-size: 36px;'>CREDIT VALIDE</h1>",unsafe_allow_html=True)
